...
var dispositivo = function(nombre, controlador, tags, opciones) {
    ...
    this.tags = tags; // Los TAGS deberán estar ordenados numéricamente
    this.tiposMB = {
    ...
    utilidades.eventos(this, {
        ...
        datosRecibidos: function(datos) {
            var buffer = utilidades.extractorBuffer(datos, this.estructuraCabecera, this.tiposMB, this.bytesPorPosicion, this.endian);   
 ...
 */
dispositivo.prototype.leer = dispositivo.prototype.read = function(arrTags, callback) {
 ...
 */
dispositivo.prototype.escribir = dispositivo.prototype.write = function(tag, valor, callback) {
 ...
 */
dispositivo.prototype.escribirPalabra = dispositivo.prototype.writeWord = function(tag, valor, callback) {
