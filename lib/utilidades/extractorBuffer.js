 ...
 */
var bufferExtraer = function(buff, estructuraCabecera, tiposMB, bytesPorPosicion, endian, noErrores) {
    if (!(this instanceof bufferExtraer)) return new bufferExtraer(buff, estructuraCabecera, tiposMB, bytesPorPosicion, endian, noErrores);
